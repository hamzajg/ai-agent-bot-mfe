  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      <div className="max-w-3xl mx-auto p-6">
        <h1 className="text-2xl font-bold mb-4">AI Agent Configuration</h1>
        <p className="text-sm text-gray-600 mb-6">Configure provider, agent context, actions and endpoints. Saved to localStorage and read by the embedded widget.</p>
        ...
        <div className="grid gap-4">
          ...
          <div className="mt-6">
            <h2 className="text-lg font-semibold mb-2">Provider API Settings</h2>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
